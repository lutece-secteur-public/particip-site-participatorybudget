...
insert into core_datastore values ('solr.app.conf.projects_mdp.template', 'skin/plugins/budgetparticipatif/projet_mdp_list_solr_search_results.html');
insert into core_datastore values ('solr.app.conf.projects_mdp.addonBeans.0', 'budgetparticipatif.BudgetSolrListAddon');
...
insert into core_datastore values ('solr.app.conf.map_projets.template', 'skin/plugins/budgetparticipatif/projet_mdp_map_solr_search_results.html');
insert into core_datastore values ('solr.app.conf.map_projets.addonBeans.0', 'budgetparticipatif.BudgetSolrAddon');
...
insert into core_datastore values ('solr.app.conf.list_projects.template', 'skin/plugins/budgetparticipatif/document_list_solr_search_results.html');
...
update core_datastore set  entity_value= "skin/plugins/budgetparticipatif/document_list_solr_search_results.html" where entity_key="solr.app.conf.list_projects.template";
