...
insert into core_datastore values ('solr.app.conf.list_proposals.template', 'skin/plugins/participatoryideation/ideation_list_solr_search_results.ftl');
...
insert into core_datastore values ('solr.app.conf.projects_mdp.template', 'skin/plugins/participatorybudget/projet_mdp_list_solr_search_results.ftl');
...
insert into core_datastore values ('solr.app.conf.map_projets.template', 'skin/pluginsparticipatorybudget/projet_mdp_map_solr_search_results.ftl');
...
insert into core_datastore values ('solr.app.conf.projects_mdp_detail.template', 'skin/pluginsparticipatorybudget/projet_mdp_details_solr_search_results.ftl');
...
insert into core_datastore values ('solr.app.conf.list_projects.template', 'skin/pluginsparticipatorybudget/document_list_solr_search_results.ftl');
...
update core_datastore set  entity_value= "skin/pluginsparticipatorybudget/document_list_solr_search_results.ftl" where entity_key="solr.app.conf.list_projects.template";
